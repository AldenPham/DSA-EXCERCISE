...
void run_Command(string command, deque &prioList){
    string action;
    int val;
    ...
    if(action == "PUSH_FRONT"){
        prioList.push_Front(val);
    }
    else if(action == "PUSH_BACK"){
        prioList.push_Back(val);
    }
    else if(action == "POP_FRONT"){
        if(prioList.get_Head() == nullptr){
            cout << "-1\n";
        }
        else{
            cout << prioList.get_Head()->val << "\n";
            prioList.pop_Front();
        }
        
    }
    else if(action == "POP_BACK"){
        if(prioList.get_Tail() == nullptr){
            cout << "-1\n";
        }
        else{
            cout << prioList.get_Tail()->val << "\n";
            prioList.pop_Back();
        }
    }
